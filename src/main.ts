...
export default async function bootstrap() {
    ...
    useContainer(app.select(PostsModule), {fallbackOnErrors: true, fallback: true});
    ...
    console.log('REPO_TYPE = ', configService.get('REPO_TYPE'), ' at ', process.env.REPO_TYPE === "SQL" ? configService.get('db.sql') : configService.get('db.orm').database)
