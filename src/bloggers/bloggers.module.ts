...
import {GetAllBloggersHandler} from "./useCase/getAllBloggersHandler";
...
@Module({
    imports: [
        CqrsModule,
        TypeOrmModule.forFeature([BlogEntity, BannedUsersEntity, PostEntity, UserEntity, LikeEntity, CommentEntity]),
