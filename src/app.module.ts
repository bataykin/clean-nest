// this should be first import ever
...
import {useConfigDB} from "./config/useConfigDB";
...
import {UpdatePostByBlogHandler} from "./bloggers/useCase/UpdatePostByBlogHandler";
...
@Module({
    imports: [
        ...
        TypeOrmModule.forRootAsync({
            ...
            useFactory: (config: ConfigService) => process.env.REPO_TYPE === "SQL" ? config.get('db.sql') : config.get('db.orm'),
